...
fn combat_controls_wait_for_the_previous_encounter_command() {
    ...
    assert!(!super::combat_control_enabled(false, false));
}
...
fn expedition_controls_wait_for_the_previous_frontier_command() {
    assert!(!super::expedition_control_enabled(true, true));
    assert!(super::expedition_control_enabled(true, false));
    assert!(!super::expedition_control_enabled(false, false));
}

#[test]
fn frontier_combat_controls_wait_for_the_previous_threat_command() {
    assert!(!super::frontier_combat_control_enabled(true, true));
    assert!(super::frontier_combat_control_enabled(true, false));
    assert!(!super::frontier_combat_control_enabled(false, false));
}

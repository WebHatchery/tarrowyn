...
use tarrowyn_protocol::{
    ...
    FoundationCacheRequest, FoundationCacheResponse, FoundationResourceRequest,
    FoundationResourceResponse, MovementIntent, MovementResponse, TradeRequest, TradeResponse,
};

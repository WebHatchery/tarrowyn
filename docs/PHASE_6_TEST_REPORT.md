...
and a support repair API. Storage version 18 also persists auth replay results,
...
`scripts/verify_mysql.ps1`: storage version 18 readiness, authoritative animal

...
| Richer route and market inspection | Follow-up surface | The online sidebar exposes compact authoritative road availability/risk, open orders, and the protected-law boundary; server projections and the runbook retain route names, stock notes, and price notes. | Add a touch-friendly detailed inspector after interaction design and playtesting establish how much regional telemetry can remain readable without displacing recovery, comparison, or chronicle controls. |

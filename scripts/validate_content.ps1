...
$required = @("content_schema.json", "game_config.json", "actions.json", "crops.json", "contracts.json", "events.json", "items.json", "threats.json", "region.json", "households.json", "settlements.json", "skills.json")
